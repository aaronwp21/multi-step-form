...
export default function Home() {
  ...
  return (
    <div className="h-[100vh] grid grid-rows-[minmax(175px,2fr),minmax(500px,3fr),75px] sm:min-h-[800px] sm:w-[80%] sm:min-w-[630px] sm:max-w-[1000px] sm:py-[10%] sm:m-auto sm:grid-rows-1 sm:grid-cols-[1fr,2fr] sm:bg-clip-content sm:bg-white">
